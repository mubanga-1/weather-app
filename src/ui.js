...
function buildMainUI() {
  ...
  const infoDisplayer = createElement({
    type: "div",
    id: "info-container",
    classList: [],
    textContent: "",
  ...
  const locationInfo = createElement({
    type: "div",
    id: "location-info",
    classList: [],
    textContent: "",
  });
  const localTimeInfo = createElement({
    type: "div",
    id: "local-time-info",
    classList: [],
    textContent: "",
  });
  localTimeInfo.innerHTML =
    "<span data-value='day'>Saturday</span> <span data-value='time'>08:00:00 AM</span>";

  const searchLocation = createElement({
    type: "div",
    id: "search-location",
    classList: [],
    textContent: "",
  ...
  const searchIconElement = createElement({
    type: "img",
    id: "search-icon",
    classList: [],
    textContent: "",
  ...
  const currentConditions = createElement({
    type: "div",
  ...
  const timeIconContainer = createElement({
    type: "div",
    id: "time-icon-wrapper",
    classList: [],
    textContent: "",
  });
  ...
  const conditionsContainer = createElement({
    type: "div",
    id: "conditions-wrapper",
    classList: [],
    textContent: "",
  });
  ...
  const tempNumber = createElement({
    type: "div",
    id: "temp",
    classList: [],
    textContent: "9",
  ...
  const unitTempWrapper = createElement({
    type: "div",
    id: "unit-and-temp",
    classList: [],
    textContent: "",
  ...
  const minTempNumber = createElement({
    type: "div",
    id: "min-temp-wrapper",
    classList: [],
    textContent: "",
  ...
  minTempNumber.innerHTML =
    "MIN <span id='min-temp' data-name='min-temp'>5</span> <sup>o</sup>C";
  ...
  const humidityContainer = createElement({
    type: "div",
    id: "humidity-wrapper",
    classList: ["detail"],
    textContent: "",
  ...
  const windSpeedContainer = createElement({
    type: "div",
    id: "wind-speed-wrapper",
    classList: ["detail"],
    textContent: "",
  });
  ...
  const precipContainer = createElement({
    type: "div",
    id: "precipitation-wrapper",
    classList: ["detail"],
    textContent: "",
  });
  ...
  const weeklyConditions = createElement({
    type: "div",
  ...
  const daysContainer = createElement({
    type: "div",
    id: "day-container",
    classList: [],
    textContent: "",
  ...
  days.forEach((day) => {
    ...
    temp.innerHTML =
      "<span data-name='max'>25</span><sup>o</sup> / <span data-name='min'>10</span><sup>o</sup>";
